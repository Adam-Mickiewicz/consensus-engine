...
const CROSS_REVIEW_PROMPT = (myRole, summaries, detail) => `You are the ${myRole}. Review these summaries and provide critical cross-review. ${summaries} ${detail} OUTPUT RULES: Single-line JSON, no newlines inside string values. Fields: agreed_with, weaknesses_found, missing_elements, suggested_changes, my_revised_position. ${LANG}`;
