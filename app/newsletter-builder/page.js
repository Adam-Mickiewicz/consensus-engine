    ...
    return `      <table class="prod" border="0" cellpadding="0" cellspacing="0" width="150" align="left" style="width:150px; max-width:150px; display:inline-block; vertical-align:top; ${marginRight}margin-bottom:8px;">
        <tr><td style="padding:0;">
          ...
          <div style="background:#ffffff; border-radius:0 0 5px 5px; padding:6px 6px 8px 6px;">
            <div style="position:relative;height:36px;overflow:hidden;"><p style="font-family:'Playfair Display',serif; font-size:12px; color:#000; margin:0 0 4px 0;">${p.name}</p><div style="position:absolute;bottom:0;left:0;right:0;height:14px;background:linear-gradient(transparent,#ffffff);"></div></div>
